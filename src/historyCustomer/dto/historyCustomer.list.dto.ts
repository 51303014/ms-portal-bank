...
import {
    USER_DEFAULT_AVAILABLE_SEARCH, USER_DEFAULT_AVAILABLE_SORT,
    USER_DEFAULT_PAGE,
    USER_DEFAULT_PER_PAGE,
    USER_DEFAULT_SORT
} from "../historyCustomer.constant";


export class HistoryCustomerListDto implements PaginationListAbstract {
    @PaginationSearch()
