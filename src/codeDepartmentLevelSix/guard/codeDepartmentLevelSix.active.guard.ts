...
import {ENUM_ROLE_STATUS_CODE_ERROR, ROLE_ACTIVE_META_KEY} from "../codeDepartmentLevelSix.constant";


@Injectable()
export class CodeDepartmentLevelSixActiveGuard implements CanActivate {
